...
from deva.ext.ext_eval_args import add_ext_eval_args, add_yolo_default_args
from deva.ext.wheat_head_seg import get_wheat_detection_model
from deva.ext.with_yolo_detector import process_frame_with_yolo as process_frame
...
if __name__ == '__main__':
    ...
    add_yolo_default_args(parser)
    deva_model, cfg, args = get_model_and_config(parser)
    sam_model = get_wheat_detection_model(cfg, 'cuda')
    """
    Temporal setting
    """
