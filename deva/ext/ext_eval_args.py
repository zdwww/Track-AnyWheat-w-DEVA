...
def add_ext_eval_args(parser: ArgumentParser):
    ...
    parser.add_argument('--GROUNDING_DINO_CONFIG_PATH',
                        default=f'{WORKSPACE_PATH}/GroundingDINO_SwinT_OGC.py')

    parser.add_argument('--GROUNDING_DINO_CHECKPOINT_PATH',
                        default=f'{WORKSPACE_PATH}/groundingdino_swint_ogc.pth')
    ...
    parser.add_argument('--SAM_CHECKPOINT_PATH', default=f'{WORKSPACE_PATH}/sam_vit_h_4b8939.pth')
    
    # HQ-SAM
    # parser.add_argument('--HQ_SAM_CHECKPOINT_PATH', default=f'{WORKSPACE_PATH}/sam_hq_vit_h.pth')
    
    # Light HQ-SAM
    # parser.add_argument('--LIGHT_HQ_SAM_CHECKPOINT_PATH', default=f'{WORKSPACE_PATH}/sam_hq_vit_tiny.pth')

    # Mobile SAM
    parser.add_argument('--MOBILE_SAM_CHECKPOINT_PATH', default=f'{WORKSPACE_PATH}/mobile_sam.pt')

    # Yolo Wheat Head Detector
    parser.add_argument('--YOLO_CHECKPOINT_PATH', default=f'{WORKSPACE_PATH}/wheat_head_detection_model.pt')
...
def add_yolo_default_args(parser):
    parser.add_argument('--img_path', default='./example/vipseg')
    parser.add_argument('--detection_every', type=int, default=5)
    parser.add_argument('--num_voting_frames',
                        default=3,
